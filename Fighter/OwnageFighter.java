...
@ScriptManifest(authors = {"Ownageful, Aut0r"}, name = "Fighter", version = 1.4, description = "<html><body style='font-family: Arial; margin: 10px;'><span style='color: #00AA00; font-weight: bold;'>Fighter</span>&nbsp;<strong>Version:&nbsp;1.4</strong><br />")
public class OwnageFighter extends Script implements PaintListener, MessageListener {
	...
	public class OwnagefulFighterGUI extends javax.swing.JFrame {
		...
		public OwnagefulFighterGUI() {
			try {
				...
				Logger.getLogger(OwnageFighter.class.getName()).log(Level.SEVERE, null, ex);
